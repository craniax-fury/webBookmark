...
<body style="font-family:Cambria;font-size:20px;">
<div style="height:65px;align: center;background: #07736f;font-family: Cambria;color: white;">
<br><b>
	<a href="" style="font-family:Cambria;font-size:34px;margin:0px 0px 0px 10px;color:white;text-decoration: none;">Bookmarking</a></b>
<div style="height:25px;background: #07736f;font-family: Cambria;color: white;">
	<b>
